...
<body>
			...
			<div class="ct_wrap">
				...
				<div class="section_store_details">
					<div class="store_details">
						<!-- 여기 -->
						<h3 class="in_tit"></h3>
						<p class="dsc" id="place_id">장소 : ${reservePage[0].placeName}</p>
						<br>
						<h3 class="in_tit">관람시간</h3>
						<p class="dsc" id="opening_hours">${reservePage[0].openingHours}</p>
					</div>
				</div>
	...
	<script type="rv-template" id="descript_id">
    ...
    <div class="count_control">
        <!-- [D] 수량이 최소 값이 일때 ico_minus3, count_control_input에 disabled 각각 추가, 수량이 최대 값일 때는 ico_plus3에 disabled 추가 -->
        <div class="clearfix">
            <a class="btn_plus_minus spr_book2 ico_minus3 disabled" id="{{priceTypeName}}_minus" title="빼기"> </a> 
            <input type="tel" class="count_control_input disabled" value="0" readonly title="수량">
             <a class="btn_plus_minus spr_book2 ico_plus3" id="{{priceTypeName}}_plus" title="더하기"> </a>
        </div>
        <!-- [D] 금액이 0 이상이면 individual_price에 on_color 추가 -->
        <div class="individual_price">
            <span class="total_price">0</span><span class="price_type">원</span>
