...
<body>
	...
	<script type="rv-template" id="booking_info">
	...
	<script type="rv-template" id="cancel_info">
	<article class="card_item">
		<a href="#" class="link_booking_details">
			<div class="card_body">
				<div class="left"></div>
	...
	<script src="<c:url value="/resources/js/myreservation.js"/>"></script>
