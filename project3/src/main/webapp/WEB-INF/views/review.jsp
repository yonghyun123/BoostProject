                ...
                <div class="review_box">
                    ...
                    <div class="short_review_area">
                        <div class="grade_area">
                            ...
                            <span class="graph_mask"> <em class="graph_value" style="width: ${sum/idx * 20}%"></em>
								</span> <strong class="text_value"> <span><fmt:formatNumber value="${sum/idx }" pattern=".0"></fmt:formatNumber></span> 
