...
public class ProductDaoSqls {
	...
	public static final String SELECT_ALL_START = "SELECT product_id id, category_id, description, content, place_name "
	...
	public static final String SELECT_BY_CATEGORY_ID = "SELECT product_id id, category_id, description, content, place_name "
			+ "FROM product, display_info "
