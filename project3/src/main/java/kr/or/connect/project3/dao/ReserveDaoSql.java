...
public class ReserveDaoSql {
	...
	public static final String GET_PRICE_INFO = "SELECT T1.id priceId, T1.product_id productId, T1.price_type_name priceTypeName, T1.price price, T1.discount_rate discountRate "
