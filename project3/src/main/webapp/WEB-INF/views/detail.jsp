...
<body>
	<div id="container">
		<div class="header fade">
			<header class="header_tit">
				<h1 class="logo">
					<a href="/project4" class="lnk_logo" title="네이버"> <span
						class="spr_bi ico_n_logo">네이버</span>
					</a> <a href="/project4" class="lnk_logo" title="예약"> <span
		...
		<div class="ct main">
			<div>
				<div class="section_visual">
					...
					<div class="pagination">
						...
						<div class="figure_pagination">
							<span class="num" id="cur-img">1</span> <span class="num off">/ <span id="total-img"></span></span>
						</div>
					</div>
							...
							<div class="prev">
								<div class="prev_inn">
									<a class="btn_prev" title="이전"> <!-- [D] 첫 이미지 이면 off 클래스 추가 -->
										<i class="spr_book2 ico_arr6_lt off right_left_group"></i>
									</a>
								</div>
							</div>
							<div class="nxt">
								<div class="nxt_inn">
									<a class="btn_nxt" title="다음">
									 <i class="spr_book2 ico_arr6_rt right_left_group"></i>
									</a>
								</div>
							</div>
						</div>
				...
				<div class="section_store_details">
					...
					<!--hidden tag를 이용한   -->
						<input type="hidden" id="productId" value="${detailList[0].productId}">
						<input type="hidden" id="displayId" value="${detailList[0].displayId}">
						<p class="dsc" id="main-content"> ${detailList[0].content}
                        </p>
					</div>
					<!-- [D] 토글 상황에 따라 bk_more에 display:none 추가 -->
					<a class="bk_more _open" id="open"> <span class="bk_more_txt">펼쳐보기</span>
						<i class="fn fn-down2"></i>
					</a> <a class="bk_more _close" id="close" style="display: none;"> <span
				...
				<div class="section_review_list">
					...
					<a class="btn_review_more" href="/project3/review/${detailList[0].displayId}"> 
				...
				<div class="section_info_tab">
					...
					<ul class="info_tab_lst">
						<li class="item active _detail"><a class="anchor active" id="detail"><span>상세정보</span></a></li>
						<li class="item _path"><a class="anchor" id="path"> <span>오시는길</span></a></li>
					</ul>
								...
								<ul class="detail_info_group">
									<li class="detail_info_lst"><strong class="in_tit">[소개]</strong>
										<div class="explain-item">
											<p class="dsc" id="in_dsc">{content}</p>
										</div>
									</li>
	...
	<script type="rv-template" id="intro-item">
		<p class="in_dsc">{{content}}
        </p>
	</script>
	<script type="rv-template" id="intro-content">
		{{content}}
	</script>
				...
				<div class="store_info">
					...
					<div class="lst_store_info_wrap">
						<ul class="lst_store_info">
							<li class="item"> <span class="item_lt"> <i class="fn fn-call2"></i> <span class="sr_only">전화번호</span> </span> <span class="item_rt"> <a href="tel:02-548-0597" class="store_tel">{{tel}}</a></span> </li>
						</ul>
					</div>
				</div>
	...
	<script type="rv-template" id="review-item">
	<li class="list_item">
		<div>
	...
	<script type="rv-template" id="review-grade">
		<span class="graph_mask"> <em class="graph_value" style="width: {{avgScorePerc}}%;"></em> </span>
		<strong class="text_value"> <span>{{avgScore}}</span> <em class="total">5.0</em> </strong>
		<span class="join_count"><em class="green">{{totalReview}}</em> 등록</span>
	</script>
